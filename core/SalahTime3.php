 ...
 */
namespace farazilu\salahtime3;

use farazilu\salahtime3\services\SalahTime3Service;
use Craft;
 ...
 */
class SalahTime3 extends Plugin
{
    ...
    public function init()
    {
        parent::init();
        $this->setComponents([
            'SalahTime3' => SalahTime3Service::class
        ]);
        self::$plugin = $this;
        ...
        Event::on(CraftVariable::class, CraftVariable::EVENT_INIT, function (Event $event) {
            ...
            $variable->set('SalahTime3', variables\SalahTime3Varable::class);
        });
         ...
         */
        Craft::info(Craft::t('SalahTime3', '{name} plugin loaded', [
            'name' => $this->name
        ]), __METHOD__);
    }
}